...
public class Panel extends JPanel {
	...
	public Panel() {
		...
		colour=JOptionPane.showOptionDialog(null, "Which color would you like to play as?", "Choose Color", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE, null, opts, opts[0]);
//		System.out.println("Player color: " + colour);
...
//		System.out.println("AI color: " + opp);
//		System.out.println("Player color: " + colour);
...
//		System.out.println("AI: " + ai.getPlayerCode());
//		System.out.println("Playr: " + colour);
...
//						System.out.println("Player: " + colour + " playing: " + y + ":" + x);
					}
				}
			}
...
//				System.out.println("AI: " + ai.getPlayerCode() + " playing: " + loc.y + ":" + loc.x);
			} 			
		}
	}
}
